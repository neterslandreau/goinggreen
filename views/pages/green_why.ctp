...
<div class="rightpanel">
	<div id="sectionone">
		<h1>Why Signs Going Green?</h1>
		<p>
			Interior way finding signs that are confusing are of no value,
			regardless of how eco friendly the inks and materials. SGS
			implements a plan to optimize the message and the medium.
		</p>
		<p>
			Exterior signs that look dull and uninspired are a waste, even
			if they use the most current LED technology. Signs Going
			Green combines appeal and economy.
		</p>
		<p>
			SGG believes signs can be attractive, effective and still kind
			to the environment.
		</p>
	</div>
</div>
